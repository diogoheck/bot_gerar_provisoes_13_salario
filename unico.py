...
LOCAL_GRAVAR_LOGS = 'R:\Compartilhado\Ti\log_provisoes\log_prov_13_salario.txt'
...
if __name__ == '__main__':
    ...
    for cod_empresa in planilha.values:
        # print('*' * 20)
        # print(cod_empresa[0], competencia)
        # print('*' * 20)
        preencher_tela_provisao_13(str(cod_empresa[0]), competencia)
        processamento_folha_1(str(cod_empresa[0]), competencia, '13 salario')
